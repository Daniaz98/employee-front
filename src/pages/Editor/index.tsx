      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-white p-10 rounded-lg shadow-md w-full max-w-4xl flex gap-10">
          ...
          <div className="flex-1 space-y-4">
            ...
            <label
              htmlFor="upload"
              className={`h-[200px] border-2 border-dashed border-purple-300 rounded-md flex-col items-center justify-center cursor-pointer bg-[#db9ddf] text-[#5c065e] text-sm font-medium text-center p-4 block ${
